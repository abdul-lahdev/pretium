...
function TrustedCompany() {
  return (
    <section className="pb-20 lg:pb-36 bg-[linear-gradient(180deg,rgba(255,255,255,1)_0%,rgba(230,189,244,1)_100%)]">
      <div className="w-[90%] xl:w-[70%] mx-auto px-0 xl:px-3 py-10 rounded-[16px]">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[2fr_1fr] gap-3">
          ...
          <div className="hidden xxl:flex justify-end  " data-aos="fade-left">
            <Image
              src="/image/formPhoto.png"
              alt="group"
              width={140}
              height={140}
              className="rounded-[18px] w-full xl:w-[400px] h-[600px] object-cover"
            />
          </div>
        </div>
