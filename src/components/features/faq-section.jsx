  ...
  return (
    <section className="pb-16 bg-white">
      ...
      <div className="mx-auto" data-aos="fade-up">
        <div className="w-[90%] lg:w-[70%]  mx-auto px-0 lg:px-3 py-10 rounded-[16px]" >


          <h2 className="text-[var(--dark4)] text-[38px]/[44px] md:text-[50px]/[64px] lg:text-[56px]/[64px] font-semibold text-center">Quick answers<br />for quick decisions</h2>
