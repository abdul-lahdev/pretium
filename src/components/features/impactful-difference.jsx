            ...
            <div className="mx-auto">
                <div className="w-[90%] xl:w-[70%] mx-auto px-0 xl:px-3 py-10 rounded-[16px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-6 mt-10">
                        ...
                        {/* LEFT IMAGE */}
                        <div className="flex justify-end items-center" data-aos="fade-right" >
                            <img
                                src={currentImage}
                            ...
                            {features.map((item) => (
                                ...
                                >
                                    <AccordionHeader
                                        ...
                                        className={`border-b-0 px-4 ${open === item.id ? "text-white bg-[var(--purple1)] text-[23px]/[34px] md:text-[23px]/[34px] xl:text-[32px]/[44px]  rounded-t-[24px] hover:text-white " : "text-black bg-[#ECF5FE] rounded-[24px] mt-5 font-medium"
                                            } font-semibold`}
                                    >
                                        <div className="flex items-center gap-3">
                                            <span className="flex items-center justify-center w-[46px] h-[46px] md:w-[46px] md:h-[46px] lg:w-[56px]  lg:h-[56px] rounded-[12px] bg-[#ECC0FC]">
                                                {
                                                    item.icon
                                                }
                                            </span>
